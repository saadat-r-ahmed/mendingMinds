# Credit Goes to https://github.com/slim-python/zoom-api-integration-create-meeting-example-code-in-python
...
API_KEY = 'YFJK96X-TwGWbjoHOQmbHQ'
API_SEC = 'etBIIHMYkiaV6Jg3zdhgQUxoxYy096dagi2y'

# your zoom live meeting id, it is optional though
meetingId = 83781439159

userId = '6kbMA3MEQ7CedA99w3XoKQ'
...
meetingdetails = {"topic": "Mend Minds",
                  "type": 2,
                  "start_time": "2022-12-30T10: 21: 57",
                  "duration": "45",
                  "timezone": "Asia/Dhaka",
                  "agenda": "test",
